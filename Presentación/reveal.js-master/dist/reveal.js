...
!(function (e, t) {
  ...
  if (Re || Ce.state) {
    var Oe = Ce.state || (Ce.state = new Te()),
      ...
      Fe = Oe.set;
    (ve = function (e, t) {
      if (De.call(Oe, e)) throw new TypeError(Ie);
  ...
  var Bi = n.Promise,
    ...
    Gi = function (e, t, n) {
      e &&
        !$i((e = n ? e : e.prototype), Xi) &&
        Yi(e, Xi, { configurable: !0, value: t });
    },
    Ji = Qe,
    Qi = _,
    Zi = a,
  ...
  if (
    ...
    (La = function () {
      var e = new xa(),
        t = uo(e);
      (this.promise = e), (this.resolve = Oo(Do, t)), (this.reject = Oo(jo, t));
    }),
    (to.f = wo =
      function (e) {
  ...
  ja({ global: !0, wrap: !0, forced: xo }, { Promise: po }),
    _a(po, co, !1),
    qa(co),
    (Pa = Fa(co)),
    ja(
  ...
  var Yo = W,
    ...
    ns = function (e) {
      var t,
        ...
        f = 0;
      if (
        (d && (u = Xo(u, c > 2 ? arguments[2] : void 0, 2)),
        null == h || (l == Array && Qo(h)))
      )
      ...
      if (
        (g &&
          ...
          el !== Object.prototype &&
            s.next &&
            ($s(s) !== el &&
              (Xs ? Xs(s, el) : "function" != typeof s[nl] && Js(s, nl, ol)),
            Gs(s, d, !0))),
        r == rl &&
          v &&
          v.name !== rl &&
  ...
  var Nl = $e,
    ...
    Dc = function (e, t, n) {
      ...
      return (
        ...
        Bl(xc, i)
          ? (n.enumerable
              ? (Bl(e, vc) && e[vc][i] && (e[vc][i] = !1),
                (n = Xl(n, { enumerable: $l(0, !1) })))
    ...
    zc = function (e) {
      ...
      return (
        ...
        (!(n || !Bl(this, t) || !Bl(xc, t) || (Bl(this, vc) && this[vc][t])) ||
          n)
      );
    },
    Hc = function (e, t) {
      ...
      if (n !== bc || !Bl(xc, i) || Bl(Lc, i)) {
        var r = Ec(n, i);
        return (
          !r || !Bl(xc, i) || (Bl(n, vc) && n[vc][i]) || (r.enumerable = !0), r
        );
      }
    },
    Uc = function (e) {
    ...
    (rc(
      (wc = function () {
        ...
        var e =
          ...
          n = function (e) {
            this === bc && n.call(Lc, e),
              Bl(this, vc) && Bl(this[vc], t) && (this[vc][t] = !1),
              Tc(this, t, $l(1, e));
          };
  ...
  Ol(
    { target: pc, stat: !0, forced: !zl },
    {
      ...
      keyFor: function (e) {
        if (!jc(e)) throw TypeError(e + " is not a symbol");
  ...
  Ol(
    ...
    { getOwnPropertyNames: Uc, getOwnPropertySymbols: Bc }
  ),
  Ol(
    {
      target: "Object",
      ...
      },
      {
        stringify: function (e, t, n) {
          for (var i, r = [e], a = 1; arguments.length > a; )
            r.push(arguments[a++]);
          if (((i = t), (ql(t) || void 0 !== e) && !jc(e)))
            return (
              _l(t) ||
                (t = function (e, t) {
                  if (
                    ("function" == typeof i && (t = i.call(this, e, t)), !jc(t))
                  )
                    return t;
                }),
              (r[1] = t),
  ...
  if (
    qc &&
    "function" == typeof Xc &&
    (!("description" in Xc.prototype) || void 0 !== Xc().description)
  ) {
    var Gc = {},
      Jc = function () {
        var e =
  ...
  if (bd(Md, !Id(" 0o1") || !Id("0b1") || Id("+0x1"))) {
    for (
      ...
      Sd(Id, (Dd = zd[Hd])) && !Sd(Fd, Dd) && Cd(Fd, Dd, Pd(Id, Dd));
  ...
  var Jd = ".slides section",
    ...
    dh = g,
    hh = Iu,
    fh = function (e, t, n, i, r, a) {
      var o = n + e.length,
        s = i.length,
        l = oh;
      return (
        void 0 !== r && ((r = nh(r)), (l = ah)),
        rh.call(a, l, function (a, l) {
          var c;
          switch (l.charAt(0)) {
            case "$":
              return "$";
  ...
  Nu("search", 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var s = Sh(r, a);
        return (
          wh(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
        );
      },
    ];
  });
  var Eh = function (e, t) {
    ...
    jh =
      /(iphone|ipod|ipad|android)/gi.test(Th) ||
      ("MacIntel" === navigator.platform && navigator.maxTouchPoints > 1),
    Dh = /chrome/i.test(Th) && !/edge/i.test(Th),
    Fh = /android/gi.test(Th),
    zh =
      "zoom" in Oh.style && !jh && (Dh || /Version\/[\d\.]+.*Safari/.test(Th)),
    Hh = {};
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (e.style.display = this.Reveal.getConfig().display),
                ...
                kh(e, "video, audio").forEach(function (e) {
                  var t = 0;
                  kh(e, "source[data-src]").forEach(function (e) {
                    e.setAttribute("src", e.getAttribute("data-src")),
                      e.removeAttribute("data-src"),
                      e.setAttribute("data-lazy-loaded", ""),
                      (t += 1);
                ...
                if (!1 === i.hasAttribute("data-loaded")) {
                  ...
                  if (o)
                    ...
                    l && u.setAttribute("loop", ""),
                      c && (u.muted = !0),
                      jh && ((u.muted = !0), u.setAttribute("playsinline", "")),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                ...
                kh(t, "iframe[src]").forEach(function (e) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                (kh(e, 'img[src$=".gif"]').forEach(function (e) {
                ...
                kh(e, "iframe[src]").forEach(function (e) {
                  (Ph(e, ".fragment") && !Ph(e, ".fragment.visible")) ||
                    t.startEmbeddedIframe({ target: e });
                }),
                kh(e, "iframe[data-src]").forEach(function (e) {
                  (Ph(e, ".fragment") && !Ph(e, ".fragment.visible")) ||
            ...
            value: function (e) {
              ...
              (n = Eh({ unloadIframes: !0 }, n)),
                e &&
                  ...
                  kh(e, "iframe").forEach(function (e) {
                    e.contentWindow &&
                      e.contentWindow.postMessage("slide:stop", "*"),
                      e.removeEventListener("load", t.startEmbeddedIframe);
                  }),
                  kh(e, 'iframe[src*="youtube.com/embed/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute("data-ignore") &&
                      e.contentWindow &&
                  ...
                  kh(e, 'iframe[src*="player.vimeo.com/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute("data-ignore") &&
                      e.contentWindow &&
            ...
            value: function () {
              ...
              (this.element.innerHTML = ""),
                ...
                this.Reveal.getHorizontalSlides().forEach(function (t) {
                  ...
                  kh(t, "section").forEach(function (t) {
              ...
              if (
                (Array.from(this.element.childNodes).forEach(function (e, n) {
                  e.classList.remove("past", "present", "future"),
                    ...
                    (t || n === i.h) &&
                      kh(e, ".slide-background").forEach(function (e, t) {
                        e.classList.remove("past", "present", "future"),
                          t < i.v
  ...
  var Xh = $t,
    ...
    sf = Math.max;
  Xh(
    { target: "Array", proto: !0, forced: !rf },
    {
      slice: function (e, t) {
        var n,
          i,
        ...
        if (
          ...
          (n !== Array && !Jh(n.prototype))
            ? Gh(n) && null === (n = n[af]) && (n = void 0)
            : (n = void 0),
          n === Array || void 0 === n)
        )
          return of.call(a, s, l);
        for (
          i = new (void 0 === n ? Array : n)(sf(l - s, 0)), r = 0;
          s < l;
          s++, r++
        )
          s in a && tf(i, r, a[s]);
  ...
  var lf = 0,
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains("fragment") &&
                ...
                e.classList.contains("fragment") &&
                  (e.className.match(th) || [""])[0] ===
                    (t.className.match(th) || [""])[0] &&
      ...
      return (
        Ri(e, [
          ...
          },
          {
            key: "disable",
            value: function () {
              kh(this.Reveal.getSlidesElement(), ".fragment").forEach(function (
                e
              ) {
            ...
            value: function () {
              ...
              if (this.Reveal.getConfig().overview && !this.isActive()) {
                (this.active = !0),
                  ...
                  kh(this.Reveal.getRevealElement(), Jd).forEach(function (t) {
            ...
            value: function () {
              ...
              this.Reveal.getHorizontalSlides().forEach(function (t, n) {
                t.setAttribute("data-index-h", n),
                  ...
                  t.classList.contains("stack") &&
                    kh(t, "section").forEach(function (t, i) {
                      t.setAttribute("data-index-h", n),
                ...
                Array.from(
                  ...
                  xh(
                    ...
                    kh(t, ".slide-background").forEach(function (t, n) {
                      xh(
                        t,
            ...
            value: function (e) {
              ...
              if (!(r || a || o || u)) {
                ...
                if ("object" === Si(t.keyboard))
                  for (d in t.keyboard)
                    "togglePause" === t.keyboard[d] && h.push(parseInt(d, 10));
                ...
                !1 === g &&
                  ...
                  80 === n || 33 === n
                    ...
                    ? l
                      ? this.Reveal.slide(0)
                      : !this.Reveal.overview.isActive() && p
                      ? this.Reveal.prev()
                      : this.Reveal.left()
                    : 76 === n || 39 === n
                    ? c
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!/^[0-9]*$/.test(r[0]) && a.length) {
                ...
                e.fragmentInURL &&
                  ((u = parseInt(r[2], 10)), isNaN(u) && (u = void 0)),
                  (h === t.h && f === t.v && void 0 === u) ||
                    this.Reveal.slide(h, f, u);
              }
            },
          },
          {
        ...
        Ri(e, [
          {
            ...
            value: function () {
              ...
              (this.element = document.createElement("aside")),
                ...
                this.Reveal.getRevealElement().appendChild(this.element),
                (this.controlsLeft = kh(t, ".navigate-left")),
                (this.controlsRight = kh(t, ".navigate-right")),
                (this.controlsUp = kh(t, ".navigate-up")),
                (this.controlsDown = kh(t, ".navigate-down")),
                (this.controlsPrev = kh(t, ".navigate-prev")),
                (this.controlsNext = kh(t, ".navigate-next")),
    ...
    Sf = function (e) {
      return function (t) {
        for (var n, i = bf(t), r = yf(i), a = r.length, o = 0, s = []; a > o; )
          (n = r[o++]), (mf && !wf.call(i, n)) || s.push(e ? [n, i[n]] : i[n]);
        return s;
      };
    },
  ...
  var Rf = (function () {
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (n = kh(this.Reveal.getRevealElement(), Jd)),
                            (i =
                              t.slideNumber &&
                        ...
                        case 15:
                          return (
                            ...
                            n.forEach(function (e) {
                              return h.Reveal.slideContent.layout(e);
                            }),
                            (e.next = 19),
                            new Promise(requestAnimationFrame)
                          );
                          ...
                          return (
                            ...
                            n.forEach(function (e, n) {
                              if (!1 === e.classList.contains("stack")) {
                                ...
                                ((1 ===
                                  (f = Math.min(f, t.pdfMaxPagesPerSlide)) &&
                                  t.center) ||
                                ...
                                if (
                                  (u.push(v),
                                  (v.className = "pdf-page"),
                                  (v.style.height =
                                    (o + t.pdfPageHeightOffset) * f + "px"),
                                  v.appendChild(e),
                                  (e.style.left = r + "px"),
                                  (e.style.top = d + "px"),
                                  (e.style.width = s + "px"),
                                  e.slideBackgroundElement &&
                                    v.insertBefore(e.slideBackgroundElement, e),
                                  t.showNotes)
                                ) {
                                  ...
                                  if (p) {
                                    ...
                                    m.classList.add("speaker-notes"),
                                      m.classList.add("speaker-notes-pdf"),
                                      m.setAttribute("data-layout", g),
                                      (m.innerHTML = p),
                                      "separate-page" === g
                                        ? u.push(m)
                                        : ((m.style.left = "8px"),
                                          (m.style.bottom = "8px"),
                                          (m.style.width = a - 16 + "px"),
                                          v.appendChild(m));
                                  }
                                }
                                if (i) {
                                  ...
                                  b.classList.add("slide-number"),
                                    b.classList.add("slide-number-pdf"),
                                    (b.innerHTML = y),
                                    v.appendChild(b);
                                }
                                if (t.pdfSeparateFragments) {
                                  ...
                                  kh(v, ".fragment:not(.fade-out)").forEach(
                                    function (e) {
                                      e.classList.add("visible");
                                    }
                                  );
    ...
    Df = jn("unscopables"),
    Ff = Array.prototype;
  null == Ff[Df] && jf.f(Ff, Df, { configurable: !0, value: Of(null) });
  var zf = function (e) {
    Ff[Df][e] = !0;
  };
  $t(
  ...
  function _f(e, t) {
    ...
    function F() {
      !0 === l.embedded
        ? (v.viewport = Ph(e, ".reveal-viewport") || e)
    ...
    function H() {
      l.showHiddenSlides ||
        kh(v.wrapper, 'section[data-visibility="hidden"]').forEach(function (
          e
        ) {
    ...
    function K(e) {
      var t = wi({}, l);
      if (("object" === Si(e) && Eh(l, e), !1 !== s.isReady())) {
        ...
        v.wrapper.classList.remove(t.transition),
          ...
          l.shuffle && Re(),
          Ah(v.wrapper, "embedded", l.embedded),
          Ah(v.wrapper, "rtl", l.rtl),
          Ah(v.wrapper, "center", l.center),
          !1 === l.pause && ge(),
          l.previewLinks
    ...
    function Y() {
      window.addEventListener("resize", nt, !1),
        ...
        v.pauseOverlay.addEventListener("click", ge, !1),
    ...
    function $() {
      O.unbind(),
        ...
        v.pauseOverlay.removeEventListener("click", ge, !1);
    }
    function X(t, n, i) {
    ...
    function J(e) {
      "string" == typeof e.layout && (f.layout = e.layout),
        ...
        f.layout
          ? xh(v.slides, f.layout + " " + f.overview)
          : xh(v.slides, f.overview);
    }
    function Q(e) {
      var t = e.target,
    ...
    function te() {
      ...
      Array.from(v.wrapper.querySelectorAll(e)).forEach(function (e) {
        /^(http|www)/gi.test(e.getAttribute("href")) &&
          e.removeEventListener("click", rt, !1);
      });
    }
    function ne(e) {
      ae(),
    ...
    function oe() {
      if (v.wrapper && !I.isPrintingPDF()) {
        if (!l.disableLayout) {
          ...
          se(l.width, l.height),
            ...
            1 === (h = Math.min(h, l.maxScale))
              ? ((v.slides.style.zoom = ""),
                ...
                J({ layout: "" }))
              : h > 1 && zh && window.devicePixelRatio < 2
          ...
          for (
            var n = Array.from(v.wrapper.querySelectorAll(Jd)),
              i = 0,
              r = n.length;
            i < r;
            i++
          ...
          t !== h &&
            Q({ type: "resize", data: { oldScale: t, scale: h, size: e } });
        }
        C.update(), k.updateParallax(), R.isActive() && R.update();
      }
    }
    function se(e, t) {
      kh(v.slides, "section > .stretch, section > .r-stretch").forEach(
        function (n) {
          var i = Ih(n, t);
    ...
    function ve() {
      return (
        ...
        (!de(a) || !a.parentNode.nextElementSibling)
      );
    }
    function pe() {
      if (l.pause) {
    ...
    function me(e) {
      "boolean" == typeof e ? (e ? pe() : ge()) : ye() ? ge() : pe();
    }
    function ye() {
    ...
    function Se(e, t, o, s) {
      ...
      if (0 !== c.length) {
        ...
        var h = n || 0,
          f = i || 0;
        (n = xe(Qd, void 0 === e ? n : e)), (i = xe(Zd, void 0 === t ? i : t));
        var g = n !== h || i !== f;
        g || (r = null);
        var m = c[n],
    ...
    function Ae() {
      Te().forEach(function (e) {
        kh(e, "section").forEach(function (e, t) {
          t > 0 &&
          ...
          o.classList.remove("past"),
            ...
            r
              ...
              ? (o.classList.add(s ? "future" : "past"),
                l.fragments &&
                  kh(o, ".fragment").forEach(function (e) {
                    e.classList.add("visible"),
                      e.classList.remove("current-fragment");
                  }))
              : a > t &&
                ...
                l.fragments &&
                  kh(o, ".fragment.visible").forEach(function (e) {
    ...
    function Le() {
      ...
      if (r && void 0 !== n) {
        ...
        jh && (a = R.isActive() ? 6 : l.mobileViewDistance),
    ...
    function Me(e) {
      ...
      if (e) {
        ...
        (r = Math.max(c.indexOf(l), 0)),
          (o = void 0),
          s && (o = Math.max(kh(e.parentNode, "section").indexOf(e), 0));
      }
        ...
        t
          ...
          : ((g = l.autoSlide),
            0 === a.querySelectorAll(".fragment").length &&
              kh(a, "video, audio").forEach(function (e) {
                e.hasAttribute("data-autoplay") &&
                  g &&
    ...
    function Ke() {
      g &&
        !b &&
        ((b = !0),
        Q({ type: "autoslidepaused" }),
        clearTimeout(m),
        o && o.setPlaying(!1));
    }
    function Ye() {
      g && b && ((b = !1), Q({ type: "autoslideresumed" }), We());
    }
    function $e() {
      (u.hasNavigatedHorizontally = !0),
        l.rtl
          ? (R.isActive() || !1 === A.next()) &&
            Pe().left &&
            Se(n + 1, "grid" === l.navigationMode ? i : void 0)
          : (R.isActive() || !1 === A.prev()) &&
            Pe().left &&
            Se(n - 1, "grid" === l.navigationMode ? i : void 0);
    }
    ...
    function Je() {
      (u.hasNavigatedVertically = !0),
        (R.isActive() || !1 === A.next()) && Pe().down && Se(n, i + 1);
    }
    function Qe() {
      var e;
      if (!1 === A.prev())
        if (Pe().up) Ge();
          ...
          (e = l.rtl
            ? kh(v.wrapper, ".slides>section.future").pop()
            : kh(v.wrapper, ".slides>section.past").pop())
        ) {
    ...
    function Ze() {
      if (
        ...
        var e = Pe();
        e.down && e.right && l.loop && he() && (e.down = !1),
          e.down ? Je() : l.rtl ? $e() : Xe();
      }
    }
    function et(e) {
  ...
  var qf = _f,
    Wf = [];
  return (
    (qf.initialize = function (e) {
      return (
        Object.assign(qf, new _f(document.querySelector(".reveal"), e)),
        Wf.map(function (e) {
          return e(qf);
        }),
        qf.initialize()
