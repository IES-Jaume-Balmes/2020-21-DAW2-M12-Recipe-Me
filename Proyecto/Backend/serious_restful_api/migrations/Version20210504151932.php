 ...
 */
<<<<<<< HEAD:Proyecto/Backend/serious_restful_api/migrations/Version20210503183246.php
final class Version20210503183246 extends AbstractMigration
=======
final class Version20210504151932 extends AbstractMigration
>>>>>>> tutorial-docker:Proyecto/Backend/serious_restful_api/migrations/Version20210504151932.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cheese_listing (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, is_published TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
